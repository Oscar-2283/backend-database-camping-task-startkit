...
set cancelled_at = '2024-11-24 17:10:25' , status = '課程已取消'
...
SELECT 
	...
	(sum(DISTINCT "CREDIT_PURCHASE".price_paid) - COALESCE(Count("COURSE_BOOKING".user_id))) as remaining_credit,
	(sum(DISTINCT "CREDIT_PURCHASE".price_paid)) as sum,
	(COALESCE(Count("COURSE_BOOKING".user_id))) as total
FROM "CREDIT_PURCHASE" 
...
and created_at <= '2024-12-30 23:59:59'
and status != '課程已取消';